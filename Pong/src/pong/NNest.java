...
public class NNest extends Application implements Serializable{
    ...
    public class NN implements Serializable{
        ...
        public void save(){
            try{
                FileOutputStream fileOut = new FileOutputStream(System.getProperty("user.dir") + "/" + name + "neuralnetwork(" + toString() + ")");
        ...
        public boolean load(){
            try{
                FileInputStream fileIn = new FileInputStream(System.getProperty("user.dir") + "/" + name + "neuralnetwork(" + toString() + ")");
